...
from ... import signals
from general.models import RegistrationProfile, Student, Faculty 
from ...views import ActivationView as BaseActivationView
from ...views import RegistrationView as BaseRegistrationView
from ...views import FacultyRegistrationView as BaseFacultyRegistrationView
...
class FacultyRegistrationView(BaseFacultyRegistrationView):
    """
    A registration backend which follows a simple workflow:
    ...
    * The creation of the templates
    ...
    def register(self, request, form):
        ...
        new_user = Faculty.objects.create_inactive_user( 
            new_user=new_user_instance,
            site=site,
            send_email=self.SEND_ACTIVATION_EMAIL,
            request=request,
