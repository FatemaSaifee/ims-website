...
urlpatterns = patterns('',
	...
	url(r'^faculty/(?P<pk>\d+)/$', views.FacultyDetailView.as_view(), name='facultydetail'),
	url(r'^news/$', views.NewsView, name='news'),
	# url(r'^notification/$', views.NotificationView.as_view(), name='notification'),
	url(r'^notification/$', views.NoticeView, name='notification'),
	url(r'^notice/$', views.NotificationView, name='notification'),
